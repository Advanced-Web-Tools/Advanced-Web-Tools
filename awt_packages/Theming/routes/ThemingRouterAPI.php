...
final class ThemingRouterAPI extends RuntimeRouterAPI
{
    ...
    public function main(): void
    {
        ...
        $this->addRouter(router: new Router("/theming/menu/save", "saveMenuItem", $this->controllerAPI->getController("ThemingController")));
        $this->addRouter(router: new Router("/theming/menu/delete", "deleteMenuItem", $this->controllerAPI->getController("ThemingController")));
