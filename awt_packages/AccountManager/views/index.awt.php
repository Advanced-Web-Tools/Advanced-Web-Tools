...
<script type="module" src="@assets('js/AccountManager.js')"></script>
@endsection
...
<div class="profile">
    <div class="header">
        <img src="@urlVar('profile.profile_picture')" alt="" class="profile_picture">
        <div class="wrapper">
            <h3 class="fullname">
        ...
        <div class="actions">
            ...
            <?php if ($this->admin->checkPermission($this->profile->permission_level) && $this->admin->permission_level <= 1 || $this->profile->id === $this->admin->id): ?>
