    ...
    public function packageExtractor()
    {
        ...
        while ($this->xml->read()) {
            ...
            if ($this->xml->name != 'theme' && $this->xml->name != '#text') {
                if ($this->xml->name == 'name') $return['installer']['info']["name"] = $this->xml->readString();
                if ($this->xml->name == 'description') $return['installer']['info']["description"] = $this->xml->readString();
                if ($this->xml->name == 'placeholder') $return['installer']['info']["placeholder"] = $this->xml->readString();
                if ($this->xml->name == 'version') $return['installer']['info']["version"] = $this->xml->readString();
            }
        }
        ...
        if ($action == 'install' && $name != '') {
            ...
            while ($this->xml->read()) {
                ...
                if ($this->xml->name != 'theme' && $this->xml->name != '#text') {
                    ...
                    if ($this->xml->name == 'placeholder') $placeholder = $this->xml->readString();
                }
            }
